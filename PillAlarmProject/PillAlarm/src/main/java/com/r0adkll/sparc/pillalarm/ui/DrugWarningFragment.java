 ...
 */
public class DrugWarningFragment extends Fragment{
    public static DrugWarningFragment createInstance(Drug drug){
        DrugWarningFragment frag = new DrugWarningFragment();
        frag.data = drug;
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_drug_warning, container, false);
    }
