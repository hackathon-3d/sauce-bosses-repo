...
object Data {
	val data = Seq(
		Map(
			...
			"side_effects" -> "Loss of appetite, weight loss, dry mouth, stomach upset/pain, nausea/vomiting, dizziness, headache, diarrhea, fever, nervousness, and trouble sleeping may occur. If any of these effects persist or worsen, tell your doctor promptly.",
			"precautions" -> "This drug may make you dizzy. Do not drive, use machinery, or do any activity that requires alertness until you are sure you can perform such activities safely. Limit alcoholic beverages"
		),
		Map(
			"name" -> "Cymbalta",
		...
		Map(
			...
			"side_effects" -> "Upset stomach, nausea, heartburn, headache, drowsiness, or dizziness may occur. If any of these effects persist or worsen, tell your doctor or pharmacist promptly.",
			"precautions" -> "This drug may make you dizzy or drowsy. Do not drive, use machinery, or do any activity that requires alertness until you are sure you can perform such activities safely. This medicine may cause stomach bleeding. Daily use of alcohol and tobacco, especially when combined with this medicine, may increase your risk for stomach bleeding. Limit alcohol and stop smoking. Consult your doctor or pharmacist for more information. This medication may make you more sensitive to the sun. Avoid prolonged sun exposure, tanning booths, and sunlamps. Use a sunscreen and wear protective clothing when outdoors."
		),
		Map(
			"name" -> "Wellbutrin",
